...
jsonSqlControllers.controller('CreateDBCtrl', ['$scope', '$location', function($scope, $location) {
...
jsonSqlControllers.controller('QueryDBCtrl', ['$scope', '$location', function($scope, $location) {
